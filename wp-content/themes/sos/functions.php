...
function create_main_banner_type() {

	$labels = array(
		'name'                  => 'Main Banners',
		'singular_name'         => 'Main Banner',
		'menu_name'             => 'Banners Main',
	...
	register_post_type( 'banner_main', $args );

}
add_action( 'init', 'create_main_banner_type', 0 );
